...
def get_new_elos(req: AdjustEloDTO) -> [LegoSetDTO]:
    ...
    winner_new_rating = get_new_rating(winner.elo, 1, calc_expected_score(loser.elo, winner.elo))
    loser_new_rating = get_new_rating(loser.elo, 0, calc_expected_score(winner.elo, loser.elo))
